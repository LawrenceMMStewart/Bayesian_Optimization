...
#     #Use Bayesian OPtimization to find the next best rate to choose & evaluate
    ...
    Bayesian_MSE=cat(1,Bayesian_MSE,[Train_Neural_Net_Loop(epochs,Layer_1,Layer_2,Bayesian_Learning_Rates[k])[3]])
    println("Epoch Complete")
...
print(size(Bayesian_Learning_Rates))
...
ax = axes()
plot(Bayesian_Learning_Rates,Bayesian_MSE,alpha=0.75)
plot(Random_Learning_Rates,Random_MSE,alpha=0.75)
